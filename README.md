...
- Quản lý danh sách URL/domain uy tín do người dùng thêm vào hệ thống.
- Kiểm tra trùng lặp khi thêm domain uy tín.
- Kiểm tra định dạng domain và hiển thị lý do cụ thể nếu domain không hợp lệ.
- Lưu lịch sử quét vào SQL Server.
- Hiển thị trang chi tiết kết quả quét URL.
- Hiển thị trang giới thiệu mô tả cách hoạt động, cách tính điểm và công nghệ sử dụng.
